      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mt-4">
            ...
            <p className="text-green-500 mt-2">Performance is 30% better than last month</p>
          </div>
          <div className="mt-6">
            <button className="bg-black text-white px-4 py-2 rounded">View All Earnings</button>
          </div>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-500">Our most popular plan for small teams.</p>
          ...
          <div className="mt-6 flex space-x-4">
            ...
            <button className="bg-gray-200 text-black px-4 py-2 rounded">Cancel Plan</button>
          </div>
        </div>
      </div>
    </div>
